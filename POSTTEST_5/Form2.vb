Public Class Form2
    ...
    ' Tombol Ubah di Form 2
    Private Sub btnUbah_Click(sender As Object, e As EventArgs) Handles btnUbah.Click
        If txtIDLayanan.Text = "" Then
            MessageBox.Show("Pilih layanan yang mau diubah!")
            Exit Sub
        End If

        If UbahLayanan(txtIDLayanan.Text, txtNamaLayanan.Text, Convert.ToInt32(txtHargaDasar.Text)) Then
