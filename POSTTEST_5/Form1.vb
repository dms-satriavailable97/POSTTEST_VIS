...
Public Class Form1
    ...
    Private Sub btnUbah_Click(sender As Object, e As EventArgs) Handles btnUbah.Click
        ...
        Dim total As Integer = HitungTotal()
        If UbahJoki(txtUID.Text, txtUsername.Text, txtPassword.Text, cmbLayanan.SelectedValue.ToString(), Convert.ToInt32(cmbKesulitan.Text), total) Then
